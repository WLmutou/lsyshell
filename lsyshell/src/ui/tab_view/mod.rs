...
use egui_term::{Authentication, PtyEvent, TermType, Terminal, TerminalContext, TerminalOptions, TerminalTheme, TerminalView};
use terminal::TerminalTab;
use homedir::my_home;
use tracing::error;
use crate::app::{LsyShell, LsyShellOptions};
use crate::ui::tab_view::session::SessionList;
use crate::utils::consts::GLOBAL_COUNTER;
